...
<body>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="input">
        <table border="0" width="50%" align="center" cellpadding="5">
            <tr>
                <td colspan="3">Nobp :19101152630182&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nama:Repi Marisko</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="radio" name="jk" id="A" value="A" checked> A
                    <input type="radio" name="jk" id="B" value="B"> B
                    <input type="radio" name="jk" id="C" value="C"> C
                    <input type="radio" name="jk" id="D" value="D"> D
                    <input type="radio" name="jk" id="E" value="E"> E
                </td>
            </tr>
